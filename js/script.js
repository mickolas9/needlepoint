...
// const grid = document.getElementById("infinite-scroll");
// const totalItems = 20; // Number of items you want to duplicate for scrolling
// let gridItemsHTML = grid.innerHTML;

// // Duplicate grid items to have enough content for scrolling
// for (let i = 0; i < totalItems; i++) {
//     gridItemsHTML += grid.innerHTML;
// }

// grid.innerHTML = gridItemsHTML;

// // Setup GSAP ScrollTrigger for infinite loop
...
//       // Apply fade effect to other items
...
//       // Create a marquee effect for the item name
//       itemName.innerHTML = `<div class="marquee">${itemName.textContent.repeat(20)}</div>`;
...
//         white-space: nowrap;
//         overflow: hidden;
//         top: ${item.getBoundingClientRect().top + window.scrollY}px;
//         z-index: 0; /* Adjust if necessary */
//       `;
//       const marquee = itemName.querySelector('.marquee');
//       marquee.animate([
...
//       // Remove fade effect from other items
//       gridItems.forEach(otherItem => {
//         otherItem.classList.remove('fade-out');
//       });

//       // Reset item name style and content
//       itemName.style.cssText = '';
//       itemName.textContent = itemName.querySelector('.marquee').textContent.slice(0, itemName.textContent.length / 20);
//     });
//   });
// });
